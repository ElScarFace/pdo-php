...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2020 a las 18:14:09
...
--
ALTER TABLE `productos`
  MODIFY `Nro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
